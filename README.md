# Elastic Metrics Firehose to Signal Demo

A portable demo repository demonstrating how OpenTelemetry Collector metric shaping reduces time series cardinality and cost while preserving SLO-level signal, with metrics sent to Elastic Serverless via OTLP.
